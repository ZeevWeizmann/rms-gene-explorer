...
# st.form: file selection does not trigger rerun during transfer (avoids ClientDisconnect)
# _upload_render fragment: gene selection only reruns the render, not the full app
@st.fragment
def _upload_render():
